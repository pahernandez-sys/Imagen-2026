...
st.markdown("""
    ...
    .contador-registros { color: #005596 !important; font-size: 1.1rem; font-weight: 700; padding: 12px; border-left: 5px solid #005596; background-color: #E8F0F8; margin-bottom: 25px; border-radius: 4px; }
...
if df is not None:
    ...
    # Filtro de Área con protección contra tipos de datos mezclados
    ...
    # Mostrar resultados (Límite 100 para velocidad)
